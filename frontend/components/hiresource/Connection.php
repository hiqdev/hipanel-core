...
class Connection extends Component
{
    ...
    public function init()
    {
        foreach ($this->nodes as $node) {
            if (!isset($node['http_address'])) {
                throw new InvalidConfigException('Hiresource node needs at least a http_address configured.');
            }
        }
    }
    /**
    ...
    public function open()
    {
        ...
        if (empty($this->nodes)) {
            throw new InvalidConfigException('Hiresource needs at least one node to operate.');
        }
