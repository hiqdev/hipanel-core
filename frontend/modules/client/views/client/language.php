...
$widgetIndexConfig = [
    ...
    'columns'       => [
        [
            ...
            'format'    => 'raw',
            'value'     => function ($data) {
                return HTML::input("hidden", "ids[{$data->id}][id]", $data->id, ['readonly' => 'readonly']) .  HTML::tag('span', $data->login);
            }
        ],
        [
            ...
            'format'    => 'raw',
            'value'     => function ($data) {
                return Html::dropDownList("ids[$data->id}][language]", $data->language, \frontend\models\Ref::getList('type,lang', true));
            }
        ],
    ],
];
